#include "IsoscelesTriangle.h"		// Равнобетренный треугольник

IsoscelesTriangle::IsoscelesTriangle() : IsoscelesTriangle{ 10, 20, 50, 60 }
{}

IsoscelesTriangle::IsoscelesTriangle(int a, int b, int A, int B) : Triangle{ "Равнобетренный треугольник", a, b, a, A, B, A }
{}
